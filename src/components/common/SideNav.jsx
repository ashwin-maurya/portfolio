...
export default function SideNav() {
  ...
  return (
    <>
      ...
      >
        <aside className="relative  z-40 h-screen ">
          <div
            className={`fixed transition-all ease-in-out delay-150 duration-200  top-0 left-0 w-full max-w-[20%] h-[96%]  m-2 bg-gray-100 dark:bg-[#111111] ${
